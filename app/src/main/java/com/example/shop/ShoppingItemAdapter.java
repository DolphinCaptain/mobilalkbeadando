...
public class ShoppingItemAdapter
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void bindTo(ShoppingItem currentItem){
            ...
            mRatingBar.setText(currentItem.getRatedInfo());
            ...
            //itemView.findViewById(R.id.delete_from_cart).setOnClickListener(view -> ((ShopListActivity)mContext).deleteItem(currentItem));
        }
    }
}